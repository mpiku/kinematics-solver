classdef dPrismConstr < constraint
    ...
    methods
      ...
      function Phi = getConstraint(obj)
          Phi = (obj.el_B.r_c + rot(obj.el_B.fi_c) * obj.s_B + ...
              - obj.el_A.r_c - rot(obj.el_A.fi_c) * obj.s_A)' * ...
              rot(obj.el_B.fi_c) * obj.u_B - obj.f( obj.el_A.solver.time );
      end
      function Jacobi = getJacobi(obj)
          R_j_v_j_T = (rot(obj.el_B.fi_c)*obj.u_B)';
          j_i_transl = [zeros(1, 3*(obj.el_A.index - 1)) -R_j_v_j_T ...
              -R_j_v_j_T*obj.omega*rot(obj.el_A.fi_c)*obj.s_A ...
              zeros(1, 3*( obj.el_B.index - obj.el_A.index - (-sign(obj.el_A.index) + 1)))];
          j_j_transl = [zeros(1, 3*(obj.el_B.index  - 1)) R_j_v_j_T ...
              -R_j_v_j_T*obj.omega*(obj.el_B.r_c - obj.el_A.r_c - rot(obj.el_A.fi_c)*obj.s_A) ...
